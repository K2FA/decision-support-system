            ...
            <tbody>
                ...
                (alternatives.map((alternative, index)=>(
                    <tr key={alternative.id}>
                        <td className="px-4 sm:px-6 align-middle border border-solid py-3 text-sm text-blueGray-500 border-slate-300 font-semibold whitespace-nowrap text-center">{++index}</td>
