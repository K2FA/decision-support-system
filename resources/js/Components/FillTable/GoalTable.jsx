                    ...
                    {goals.length !== 0 ?
                        ...
                        <tr key={goal.id}>
                            ...
                            <td className="px-2 w-36 align-middle border border-solid py-3 text-sm  border-slate-300 whitespace-nowrap text-white text-center">
                                <Link className="sm:w-1/2 bg-red-500 hover:bg-red-700 rounded p-1" as="button" onClick={()=> handleDeleteBtn(goal.id)}><i class="fa-solid fa-trash mr-1 text-xs"></i>Delete</Link>
                            </td>
                        </tr>
                        ))):(
                        <tr>
