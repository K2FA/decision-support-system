                ...
                <tbody>
                    {goals.length !== 0 ? (
                        goals.map((goal, index) => (
                            <tr key={goal.id}>
                                <td className="px-4 sm:px-6 align-middle border border-solid py-3 text-sm  border-slate-300 whitespace-nowrap text-center text-blueGray-500 font-semibold">
                                    {++index}
                                </td>
                                <td className="px-4 sm:px-6 align-middle border border-solid py-3 text-sm  border-slate-300 whitespace-nowrap text-left text-blueGray-500 font-semibold">
                                    {goal.name}
                                </td>
