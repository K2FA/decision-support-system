...
export default function InputAhp() {
    return (
        <>
            <tr>
                <td className="px-4 w-1/6 sm:px-6 align-middle border border-solid py-3 text-sm sm:text-base text-blueGray-700 border-slate-300 whitespace-nowrap text-center font-bold">
                    K1
                </td>
